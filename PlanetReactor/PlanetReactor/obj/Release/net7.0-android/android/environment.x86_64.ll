...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"45684faf-f76f-4019-98af-046d706507b5\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [30 x i8] c"com.companyname.planetreactor\00", align 16
...
@__DSOCacheEntry_name.13 = internal constant [26 x i8] c"libaot-MauiReactor.dll.so\00", align 16
...
@__DSOCacheEntry_name.18 = internal constant [29 x i8] c"libaot-System.CodeDom.dll.so\00", align 16
...
@__DSOCacheEntry_name.26 = internal constant [28 x i8] c"libaot-PlanetReactor.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [524 x %struct.DSOCacheEntry] [
	...
	; 27
	%struct.DSOCacheEntry {
		i64 1072336413024656797, ; hash 0xee1b449420d1d9d, from name: aot-PlanetReactor
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.26, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 28
	%struct.DSOCacheEntry {
	...
	; 69
	%struct.DSOCacheEntry {
		i64 2863838023507516027, ; hash 0x27be6582556c1a7b, from name: libaot-PlanetReactor.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.26, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 321
	%struct.DSOCacheEntry {
		i64 11722056454315748901, ; hash 0xa2ad1c3d3490ae25, from name: libaot-PlanetReactor
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.26, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 448
	%struct.DSOCacheEntry {
		i64 15708002141639215636, ; hash 0xd9fe08b9277b0a14, from name: PlanetReactor
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.26, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 486
	%struct.DSOCacheEntry {
		i64 17180798483071746311, ; hash 0xee6e75314d0fc107, from name: aot-PlanetReactor.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.26, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 488
	%struct.DSOCacheEntry {
		i64 17301503347235375692, ; hash 0xf01b49a084324a4c, from name: PlanetReactor.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__DSOCacheEntry_name.26, i32 0, i32 0), ; name
		i8* null; handle
	}, 
