...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"df940583-e761-4543-9bf1-f05995c7bba7\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [28 x i8] c"com.companyname.mauislanted\00", align 1
...
@__DSOCacheEntry_name.4 = internal constant [26 x i8] c"libaot-MauiSlanted.dll.so\00", align 1
...
@__DSOCacheEntry_name.22 = internal constant [36 x i8] c"libaot-System.Runtime.Loader.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [524 x %struct.DSOCacheEntry] [
	...
	; 3
	%struct.DSOCacheEntry {
		i64 48642953, ; hash 0x2e63b89, from name: aot-MauiSlanted
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 4
	%struct.DSOCacheEntry {
	...
	; 80
	%struct.DSOCacheEntry {
		i64 723093194, ; hash 0x2b1986ca, from name: aot-MauiSlanted.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 122
	%struct.DSOCacheEntry {
		i64 1060887655, ; hash 0x3f3bdc67, from name: MauiSlanted
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 203
	%struct.DSOCacheEntry {
		i64 1765520313, ; hash 0x693bb3b9, from name: MauiSlanted.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 233
	%struct.DSOCacheEntry {
		i64 1969998141, ; hash 0x756bc93d, from name: libaot-MauiSlanted.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 411
	%struct.DSOCacheEntry {
		i64 3274177527, ; hash 0xc327fbf7, from name: libaot-MauiSlanted
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.4, i32 0, i32 0), ; name
		i8* null; handle
	}, 
