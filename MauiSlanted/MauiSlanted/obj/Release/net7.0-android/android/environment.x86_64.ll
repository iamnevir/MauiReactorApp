...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"df940583-e761-4543-9bf1-f05995c7bba7\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [28 x i8] c"com.companyname.mauislanted\00", align 16
...
@__DSOCacheEntry_name.12 = internal constant [26 x i8] c"libaot-MauiSlanted.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [524 x %struct.DSOCacheEntry] [
	...
	; 11
	%struct.DSOCacheEntry {
		i64 385749746754549177, ; hash 0x55a7559d38075b9, from name: aot-MauiSlanted.dll.so
		i8 0, ; ignore
	...
	; 35
	%struct.DSOCacheEntry {
		i64 1268597213536199174, ; hash 0x119af671c3e02206, from name: aot-MauiSlanted
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 73
	%struct.DSOCacheEntry {
		i64 2920417127209416721, ; hash 0x288767e77748b811, from name: libaot-MauiSlanted
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 237
	%struct.DSOCacheEntry {
		i64 8861285314604439548, ; hash 0x7af99c0b666217fc, from name: MauiSlanted
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 362
	%struct.DSOCacheEntry {
		i64 12912379715408790376, ; hash 0xb331fcf03de68368, from name: MauiSlanted.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 480
	%struct.DSOCacheEntry {
		i64 16810701410261339029, ; hash 0xe94b9bdd9fc90b95, from name: libaot-MauiSlanted.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.12, i32 0, i32 0), ; name
		i8* null; handle
	}, 
